...
export const DATA_FETCH_FAQ_DATA_REQUEST = 'DATA_FETCH_FAQ_DATA_REQUEST';
export const DATA_RECEIVE_FAQ_DATA = 'DATA_RECEIVE_FAQ_DATA';


export const DATA_FETCH_LAYERS_DATA_REQUEST = 'DATA_FETCH_LAYERS_DATA_REQUEST';
export const DATA_RECEIVE_LAYERS_DATA = 'DATA_RECEIVE_LAYERS_DATA';
